...
class ModuleLoader {
  ...
  async loadNetworkModule() {
    const {
      NetworkModule
    } = await Promise.resolve().then(function () { return require('../modules/NetworkModule.cjs'); });
  ...
  async loadBatteryModule() {
    const {
      BatteryModule
    } = await Promise.resolve().then(function () { return require('../modules/BatteryModule.cjs'); });
  ...
  async loadGeolocationModule() {
    const {
      GeolocationModule
    } = await Promise.resolve().then(function () { return require('../modules/GeolocationModule.cjs'); });
  ...
  async loadFeatureDetectionModule() {
    ...
    } = await Promise.resolve().then(function () { return require('../modules/FeatureDetectionModule.cjs'); });
  ...
  async loadPerformanceModule() {
    const {
      PerformanceModule
    } = await Promise.resolve().then(function () { return require('../modules/PerformanceModule.cjs'); });
  ...
  async loadMediaModule() {
    const {
      MediaModule
    } = await Promise.resolve().then(function () { return require('../modules/MediaModule.cjs'); });
  ...
  async preload(names) {
    ...
    try {
      await index.asyncPool(3, needLoad, async (name) => {
  ...
  async loadMultiple(names, concurrency = 3) {
    ...
    const modules = await index.asyncPool(concurrency, toLoad, async (name) => {
...
//# sourceMappingURL=ModuleLoader.cjs.map
