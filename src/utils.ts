import type { DeviceType, Orientation, DeviceDetectionConfig } from './types'
import { DeviceType as DeviceTypeEnum, Orientation as OrientationEnum, DEFAULT_DEVICE_CONFIG } from './types'
