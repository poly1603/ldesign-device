...
import type { BatteryInfo, DeviceDetector } from '@ldesign/device-core'
import process from 'node:process'
import { computed, onUnmounted, readonly, ref } from 'vue'
import { DeviceDetector as CoreDeviceDetector } from '@ldesign/device-core'

/**
 * 电池状态检�?Composition API
 *
 ...
 *     <p>充电状�? {{ isCharging ? '充电�? : '未充�? }}</p>
 *     <p>电池状�? {{ batteryStatus }}</p>
 *   </div>
 *   <div v-else>
 *     <p>电池信息不可�?/p>
 *   </div>
