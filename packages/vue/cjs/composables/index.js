...
var useBattery = require('./useBattery.js');
var useBreakpoints = require('./useBreakpoints.js');
var useDevice = require('./useDevice.js');
var useGeolocation = require('./useGeolocation.js');
var useOrientation = require('./useOrientation.js');
var useMediaCapabilities = require('./useMediaCapabilities.js');
var useWakeLock = require('./useWakeLock.js');
var useVibration = require('./useVibration.js');
var useClipboard = require('./useClipboard.js');
var useOrientationLock = require('./useOrientationLock.js');
