...
function getGlobalDetector() {
  if (!globalDetector) {
    globalDetector = new deviceCore.DeviceDetector();
  }
...
exports.__resetGlobalState = __resetGlobalState;
exports.__setGlobalDetector = __setGlobalDetector;
exports.cleanupGlobalDetector = cleanupGlobalDetector;
exports.vDevice = vDevice;
exports.vDeviceDesktop = vDeviceDesktop;
exports.vDeviceMobile = vDeviceMobile;
exports.vDeviceTablet = vDeviceTablet;
